...
app.get('/issues', (req, res) => res.redirect(301, 'https://github.com/electron/voteit.se/issues'))
app.get('/issues/new', (req, res) => res.redirect(301, 'https://github.com/electron/voteit.se/issues/new'))
app.get('/languages', routes.languages.index)
app.get('/maintainers/join', (req, res) => res.redirect('https://goo.gl/FJmZZm'))
app.get('/pulls', (req, res) => res.redirect(301, 'https://github.com/electron/voteit.se/pulls'))
